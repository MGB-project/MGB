"""
Django settings for mgbapp project.
...
ALLOWED_HOSTS = ['mgbapp-d21b099fdee0.herokuapp.com', '127.0.0.1', 'localhost']
...
WSGI_APPLICATION = 'mgbapp.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'mgb_website',
        'USER': 'yaadtiahh_admin',
        'PASSWORD': '!9Hz8X5Bbt##', 
        'HOST': 'localhost',
        'PORT': '5432',
    }
